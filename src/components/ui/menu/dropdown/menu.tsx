...
export default function Menu({
  ...
  function findElement(element: HTMLElement, selector: string) {
    ...
    while ((isElement = isElement.parentElement) && !isElement.matches(selector));
    return isElement;
  }
  ...
  function getItemIndex(node: HTMLButtonElement) {
    ...
    return Array.from(findElement(node, '[data-menu-dropdown]')?.querySelectorAll('[data-menu-item]') || []).findIndex((element) => element === node);
  }
