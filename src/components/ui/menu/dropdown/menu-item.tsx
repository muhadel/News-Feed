...
export const MenuItem = forwardRef<HTMLElement, MenuItemProps & React.HTMLProps<HTMLButtonElement>>(
  ({ children, className, closeMenuOnClick = true, disabled, as = 'li', loop, compound = true, ...props }, ref) => {
    const Component = as;
