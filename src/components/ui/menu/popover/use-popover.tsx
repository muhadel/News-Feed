import { flip, inline, limitShift, Middleware, offset, shift, size, useFloating, UseFloatingReturn } from '@floating-ui/react';
import { useUncontrolled } from '@/components/ui/menu/dropdown/use-uncontrolled';
import { FloatingAxesOffsets, FloatingPosition } from '@/components/ui/menu/popover/types';
...
function getPopoverMiddlewares(options: UsePopoverOptions, getFloating: () => UseFloatingReturn<Element>) {
