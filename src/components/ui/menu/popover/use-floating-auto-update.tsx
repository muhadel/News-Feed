...
export function useFloatingAutoUpdate({ opened, floating, position, positionDependencies }: FloatingAutoUpdateProps) {
  ...
  useEffect(() => {
    ...
    return undefined;
  }, [opened, delayedUpdate, position, floating.refs.reference, floating.refs.floating, floating.update]);
