...
export const PopoverTrigger = React.forwardRef<HTMLElement, PopoverTargetProps & React.HTMLProps<HTMLButtonElement>>(
  ({ children, popupType = 'dialog', refProp = 'ref', ...props }, ref) => {
    ...
    return cloneElement(children, {
      ...
      ...accessibleProps,
      ...ctx.targetProps,
      className: cn(ctx.targetProps.className, forwardedProps.className, children.props.className),
      [refProp!]: targetRef,
