...
import { PopoverWidth, usePopover } from '@/components/ui/menu/popover/use-popover';
import { FloatingPlacement, FloatingPosition, FloatingSide } from '@/components/ui/menu/popover/types';
...
export default function Popover({
   ...
   */
  function getFloatingPosition(dir: 'rtl' | 'ltr', position: FloatingPosition): FloatingPosition {
